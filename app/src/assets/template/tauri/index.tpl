...
<div id="loading" class="b3-dialog b3-dialog--open" style="position:fixed;inset:0;display:flex;justify-content:center;align-items:center;z-index:9999">
    <div class="b3-dialog__scrim" style="position:absolute;inset:0;background-color:#1e1e1e"></div>
